...
def post_create(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('post_detail', title=form.instance.title)
    else:
        form = PostForm()
